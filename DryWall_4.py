...
def create_interactor(coord_input, pyp_path, str_table_service):
    ...
    return InterDryWall(coord_input, pyp_path, str_table_service)


class InterDryWall():
    """
    Definition of class InterDryWall
    """
    ...
    def set_common_properties(self):
        ...
        # Wall Props
        #1
        self.wall1_thickness = self.build_ele_list[0].Left_Layer1_Thickness.value
        self.wall2_thickness = self.build_ele_list[0].Left_Layer2_Thickness.value
        self.wall3_thickness = self.build_ele_list[0].Right_Layer1_Thickness.value
        self.wall4_thickness = self.build_ele_list[0].Right_Layer2_Thickness.value
        #2
        self.wall1_type = self.build_ele_list[0].Left_Layer1_Type.value
        self.wall2_type = self.build_ele_list[0].Left_Layer2_Type.value
        self.wall3_type = self.build_ele_list[0].Right_Layer1_Type.value
        self.wall4_type = self.build_ele_list[0].Right_Layer2_Type.value
        #3
        self.midWidth = self.build_ele_list[0].MidWidth.value
        self.height = self.build_ele_list[0].Height.value
